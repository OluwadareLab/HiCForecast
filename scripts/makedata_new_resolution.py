...
# time point ids
if dataset_num == 1:
    ids = ["PN5","early_2cell","late_2cell","8cell","ICM","mESC"]
    ficool_dir = "./../new_data/GSE82185/" 
if dataset_num == 2:
...
ids = ["GSE82185_" + x + "_10000" for x in ids]
print(ids)
chrs_test = ['chr2','chr6']
chrs_val = ['chr19']
...
dir_data = "./../new_resolution_data/10kb/data_{}/dataset_{}/".format(sub_mat_n, dataset_num)
num_bins_all = []
...
def playground():
 for chr in range(1,11):
    ...
    #if chr == 20:
    #    chrid = 'chrX'
    if chrid in chrs_test:#already did 2 and 6
        continue
